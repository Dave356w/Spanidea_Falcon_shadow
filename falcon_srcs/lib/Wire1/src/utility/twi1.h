...
#define twi1_h
  ...
  /*
   * FALCON LOCAL ADDITION -- see the bounded-waits block in twi1.c.
   * Saturating count (max 255) of wait sites that hit their spin bound and
   * forced a TWI re-init. Nonzero means a wedge was caught that would
   * previously have frozen the ISR until the watchdog fired.
   */
